  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "src/notifications/delivery/codex.ts":    { statements: 90, branches: 90, functions: 90, lines: 90 },
        "src/notifications/delivery/cursor.ts":   { statements: 90, branches: 90, functions: 90, lines: 90 },
        "src/notifications/delivery/hermes.ts":   { statements: 90, branches: 90, functions: 90, lines: 90 },
      },
    },
  },
});
